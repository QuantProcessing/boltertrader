...
func TestPerpWsCallbackOverflowClosesExactSocket(t *testing.T) {
...
func TestPerpWsCallbackDispatcherIsBoundedAndStopDoesNotWaitForCallback(t *testing.T) {
...
func TestPerpWsCallbackDispatcherDropsFailedReplacementAndAllowsReentrantClose(t *testing.T) {
	dispatcher := newWSCallbackDispatcher()
