...
func (c *Client) GetAccount(ctx context.Context) (*AccountResponse, error) {
	...
	err := c.Get(ctx, c.accountEndpoint("account"), nil, true, &res)
	if err != nil {
		return nil, err
	}
	return &res, nil
...
func (c *Client) GetBalance(ctx context.Context) ([]BalanceResponse, error) {
	...
	err := c.Get(ctx, c.accountEndpoint("balance"), nil, true, &res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func (c *Client) GetPositionRisk(ctx context.Context, symbol string) ([]PositionRiskResponse, error) {
	...
	err := c.Get(ctx, c.accountEndpoint("positionRisk"), params, true, &res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func (c *Client) ChangeLeverage(ctx context.Context, symbol string, leverage int) (*LeverageResponse, error) {
	...
	err := c.Post(ctx, c.apiV1("leverage"), params, true, &res)
	if err != nil {
		return nil, err
	}
	return &res, nil
...
func (c *Client) ChangeMarginType(ctx context.Context, symbol string, marginType string) error {
	...
	err := c.Post(ctx, c.apiV1("marginType"), params, true, &res)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) GetPositionMode(ctx context.Context) (*PositionModeResponse, error) {
	...
	err := c.Get(ctx, c.apiV1("positionSide/dual"), nil, true, &res)
	if err != nil {
		return nil, err
	}
	return &res, nil
...
func (c *Client) ChangePositionMode(ctx context.Context, dualSidePosition bool) error {
	...
	err := c.Post(ctx, c.apiV1("positionSide/dual"), params, true, &res)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) GetMultiAssetsMode(ctx context.Context) (*MultiAssetsModeResponse, error) {
	...
	err := c.Get(ctx, c.apiV1("multiAssetsMargin"), nil, true, &res)
	if err != nil {
		return nil, err
	}
	return &res, nil
...
func (c *Client) ChangeMultiAssetsMode(ctx context.Context, multiAssetsMargin bool) error {
	...
	err := c.Post(ctx, c.apiV1("multiAssetsMargin"), params, true, &res)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) GetFeeRate(ctx context.Context, symbol string) (*FeeRateResponse, error) {
	...
	err := c.Get(ctx, c.apiV1("commissionRate"), params, true, &res)
	if err != nil {
		return nil, err
	}
	return &res, nil
