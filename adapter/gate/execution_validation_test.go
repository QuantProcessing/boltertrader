...
func TestExecutionClientValidateSubmitCatchesLocalFailures(t *testing.T) {
	...
	provider.LoadSnapshot([]*model.Instrument{{ID: id, VenueSymbol: "BTC_USDT"}})
	...
	t.Run("unknown instrument", func(t *testing.T) {
		req := validGateValidationRequest(id)
...
func validGateValidationRequest(id model.InstrumentID) model.OrderRequest {
